 ...
 * custom adapter for rows with a two lines of text and an optional image on the left
 */
public abstract class DetailRowAdapter extends ArrayAdapter<String> {
    ...
    public abstract String getRowDetailText(Integer position);
    ...
    public View getView(int position, View convertView,@NonNull ViewGroup parent) {
        ...
        //get the text (second line) with this abstract method, which will usually be implemented in the Fragment containing the listView
        String rowDetailText = getRowDetailText(position);
        if(rowDetailText == null) rowDetailText = "";
        ...
        if (rowView == null || !isCurrentClass || rowView.getTag() == null) {
            ...
            rowView = inflater.inflate(R.layout.row_detailrowlayout, parent, false);

            // configure view holder
            ViewHolder viewHolder = new ViewHolder();
            viewHolder.text = (TextView) rowView.findViewById(R.id.rowText);
            viewHolder.detailText = (TextView) rowView.findViewById(R.id.rowDetail);
        ...
        holder.detailText.setText(rowDetailText);
