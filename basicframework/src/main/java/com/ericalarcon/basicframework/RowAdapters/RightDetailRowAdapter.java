 ...
 */
public abstract class RightDetailRowAdapter extends ArrayAdapter<String> {
    ...
    public RightDetailRowAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null || !isCurrentClass || rowView.getTag() == null) {
            ...
            rowView = inflater.inflate(R.layout.row_rightdetailrowlayout, parent, false);
